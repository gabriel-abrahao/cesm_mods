...
pefolder=$modsfolder"/veg_setup_scripts/pe_layouts/"
queue="cpu_dev"
...
cat $nlfolder/user_nl_clm| sed "s/_\(rcp[0-9]\.[0-9]\)_/_"$rcp"_/" | sed "s/_rochedo_\([a-z]\{3\}\)_/_"$scenario"_/"| sed "s/_c[0-9][0-9]*.nc/_"$filetag".nc/" >user_nl_clm
